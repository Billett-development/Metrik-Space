...
class HeroAnimation extends Component {
    componentDidMount() {
     ...
     scene.add( cube, cube2, cube3, cube4, cube5, cube6, cube7, cube8, cube9, cube10, cube11, cube12, cube13, cube14, cube14, cube15, cube16, cube17, cube18, cube19, cube20, cube21, cube22);
     cube.position.z = -4;
     cube2.position.z = -4;
     cube3.position.z = -4;
     cube4.position.z = -4;
     ...
     particleMaterial = new THREE.ParticleBasicMaterial({ color: 0x313639, size: 2 });
    ...
    var mouseTolerance = 0.4;
     ...
     particleSystem.rotation.x = (e.clientY - centerY) / centerY * mouseTolerance;
     particleSystem.rotation.y = (e.clientX - centerX) / centerX * mouseTolerance;
     };
